        ...
        <div class="col-lg-2 col-md-2 col-sm-2">
        	<div id="left-nav">
            	<ul id="left-navbar">
            		...
            		<li class="active"><a href="auto.jsp">Auto Complete</a></li>
              ...
              <div id="more-tab">
                ...
                <div>
                  ...
                  <ul class="nav nav-tabs">
                    <li class="active"><a href="#a" data-toggle="tab">Single Values</a></li>
                    <li><a href="#b" data-toggle="tab">Multiple Values</a></li>
                  </ul>
