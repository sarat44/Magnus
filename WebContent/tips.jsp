              ...
              <div id="more-tab">
                ...
                <div>
                  ...
                  <ul class="nav nav-tabs">
                    <li class="active"><a href="#a" data-toggle="tab">Tooltips</a></li>
                  </ul>
                  
                  <div class="tab-content">
                   <div class="tab-pane fade in active" id="a">
                      <button id="btn-tip" class="btn btn-info" title="You have not clicked this BUTTON yet. Please Click me and check the tooltip"> Check The Tooltip Before You Click.</button>
                   </div>
                  </div>
